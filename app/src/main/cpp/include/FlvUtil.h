...
#define BUFFMAX 1024*1024*5 //1M//4096;
...
int flv_write_audio_packet(flv_t *pb, unsigned char *packetData, int
size,
                           unsigned int ts
);
